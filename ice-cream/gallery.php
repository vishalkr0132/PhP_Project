    ...
    <section class="gallery py-5">
        <div class="container py-xl-5 py-lg-3">
            <div class="title-heading text-center mb-sm-5 mb-4">
                <h3 class="title text-capitalize text-dark">gallery</h3>
                    ...
                    <div class="col-sm-4 section_1_gallery_grid " style="width: 400px; margin-top:30px; margin-bottom: 30px;">
                        <a href="images/g1.jpg">
                            ...
                            if($image_name!=="")
                            {
                                //Display the Image
                                ?>
                                <img src="<?php echo SITEURL;?>images/gallery/<?php echo $image_name;?>" height="250px" width="350px">
